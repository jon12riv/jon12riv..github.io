(function (window) {
    ...
    /**
     The goal is to get all 3 collectibles
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.db, 850, 450, 60, 60);
        collectable.create(type.db, 300, 315, 365, 1000);
        collectable.create(type.db, 200, 40, .2, 90);
